...
void OGLRenderer::SetTextureRepeating(GLuint tex, bool repeating) {
...
void OGLRenderer::SetShaderLight2(const Light& l) {
	...
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightDirection2"), 1, (float*)&l.GetDirection());
